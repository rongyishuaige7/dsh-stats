...
var require_rpc_schemas = __commonJS({
  "src/rpc-schemas.cjs"(exports, module) {
    module.exports = function createRpcSchemas2(z2) {
      ...
      const pricingRequestSchema2 = z2.object({ action: z2.enum(["status", "refresh", "preview", "save", "rollback"]), fingerprint: z2.string().max(64).optional(), revision: z2.number().int().nonnegative().optional(), version: z2.number().int().positive().optional(), autoUpdate: z2.boolean().optional(), overridesJson: z2.string().max(262144).optional() }).strict().optional();
