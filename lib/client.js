		...
		function exportCSV(projects, t) {
		  ...
		  projects.forEach(function(p) {
		    ...
		    lines.push([
		      ...
		      p.sessionCount,
		      JSON.stringify(fmtSessionCounts(sessionCounts(p.sessions), t)),
		      s.turns,
		      s.steps,
		      Math.round(s.llmMs),
		      Math.round(s.toolMs),
