window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function statLine(st) {
		  var parts = [];
		  parts.push(`${fmtN(st.turns)} \u8F6E \xB7 ${fmtN(st.steps)} \u6B65`);
		  var dur = [];
		  ...
		  parts.push(`\u8F93\u5165 ${fmtTokens(st.inputTokens)} tok \xB7 \u8F93\u51FA ${fmtTokens(st.outputTokens)} tok`);
		  return parts.join(" | ");
		}
		var PRICING = {
		  "deepseek-v4-pro": {
		...
		function dayStartMs(key) {
		  return (/* @__PURE__ */ new Date(key + "T00:00:00")).getTime();
		}
		          ...
		          e(
		            ...
		            p.sessions.map(
		              (sd) => e(
		                ...
		                e("span", { className: "st" }, `${fmtN(sd.stats.turns)} \u8F6E \xB7 ${fmtN(sd.stats.steps)} \u6B65`),
		                ...
		                e("span", { className: "st" }, `\u5165 ${fmtTokens(sd.stats.inputTokens)} \xB7 \u51FA ${fmtTokens(sd.stats.outputTokens)}`),
		...
		function TimelineView(props) {
		  ...
		  if (range !== "all") {
		    ...
		    if (maxKey) {
		      var cutoff = (/* @__PURE__ */ new Date(maxKey + "T00:00:00")).getTime() - (range - 1) * 864e5;
		      days = days.filter((d) => (/* @__PURE__ */ new Date(d.date + "T00:00:00")).getTime() >= cutoff);
		    }
		  }
		  ...
		  return e(
		    ...
		    days.length === 0 ? e("div", { className: "dss-empty" }, "\u8BE5\u8303\u56F4\u5185\u6682\u65E0\u5F00\u53D1\u6D3B\u52A8") : e(
		      "div",
		      null,
		      e(
		        "div",
		      ...
		      days.map((d) => {
		        ...
		        var wd = ["\u65E5", "\u4E00", "\u4E8C", "\u4E09", "\u56DB", "\u4E94", "\u516D"][(/* @__PURE__ */ new Date(d.date + "T00:00:00")).getDay()];
		        return e(
		          "div",
		    ...
		    e(
		      ...
		      e(
		        ...
		        tab === "overview" ? e(
		          ...
		          visibleProjects.length === 0 ? e("div", { className: "dss-empty" }, t("empty")) : e(ProjectsTable, { projects: rangeProjects, hidden, selected, onSelect: (id) => setSelected((s) => s === id ? null : id) })
